...
@section('content')
    <!-- Dashboard Content -->
        ...
        <!-- Charts/Graphs for streams over time) -->
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-zinc-700">
                        <thead class="bg-zinc-700">
                            <tr>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider rounded-tl-lg">
                                    Track
                                </th>
                                ...
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider rounded-tr-lg">
                                    Date
                                </th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-zinc-700 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            @if($music->cover_path)
                                                <img src="{{ asset('storage/' . $music->cover_path) }}"
                                                     alt="Album Art"
                                                     class="w-10 h-10 rounded-md mr-3 object-cover">
                                            @else
                                                <img src="https://placehold.co/40x40/333/fff?text=M"
                                                     alt="Album Art"
                                                     class="w-10 h-10 rounded-md mr-3 object-cover">
                                            @endif
            ...
            <section class="bg-zinc-800 rounded-lg p-6 shadow-xl">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <a href="{{ route('music.upload') }}"
                        class="bg-orange-600 hover:bg-orange-700 text-white font-semibold py-4 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center space-x-3">
                        <i class="fas fa-plus-circle text-2xl"></i>
                        <span>{{ __('New Release') }}</span> </a>

                    <button
                        class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-4 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center space-x-3">
                        <i class="fas fa-file-export text-2xl"></i>
                        <span>Export Data</span>
                    </button>
                    <button
                        class="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-4 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center space-x-3">
